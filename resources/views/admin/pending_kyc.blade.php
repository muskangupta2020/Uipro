...
<h6 class="mb-0 text-uppercase">Pending KYC</h6>
        <hr/>
        <div class="card">
          <div class="card-body">
        ...
        <tr>
                    ...
                    <td><a href="{{url('admin/reject_status/'.$p->user_id)}}"><button class="btn btn-danger">Rejected</button></a>&nbsp;
                      <a href="{{url('admin/approv_status/'.$p->user_id)}}"><button class="btn btn-info">Approve</button></a></td>
