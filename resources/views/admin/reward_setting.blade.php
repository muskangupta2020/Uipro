		...
		<div class="page-wrapper">
			<div class="page-content">
				...
				<div class="row">
                  ...
                  <div class="col-md-6">
                    <label for="inputFirstName" class="form-label">Reward Name</label>
                    <input type="text" class="form-control" id="inputFirstName" name="plan_name">
                  </div>
                  <div class="col-md-6">
                    <label for="inputLastName" class="form-label">Reward Based On</label>
                  ...
                  <div class="col-md-6">
                    <label for="inputEmail" class="form-label">Reward Duration</label>
