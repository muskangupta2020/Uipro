...
<script src="{{url('user/assets/js/bootstrap.bundle.min.js')}}"></script>
  ...
  <script src="{{url('user/assets/plugins/datatable/js/jquery.dataTables.min.js')}}"></script>
  <script src="{{url('user/assets/plugins/datatable/js/dataTables.bootstrap5.min.js')}}"></script>
  <script>
