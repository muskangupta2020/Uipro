							...
							<div class="col-lg-5 border-end">
								<div class="card-body">
									<div class="p-5">
										...
										<form action="{{url('user/new_password')}}" method="post">
											@csrf
										...
										<div class="d-grid gap-2">
											<button type="submit" class="btn btn-primary">Change Password</button> <a href="{{url('user/logout')}}" class="btn btn-light"><i class='bx bx-arrow-back mr-1'></i>Back to Login</a>
										</div>
									</form>
									</div>
								</div>
