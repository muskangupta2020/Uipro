      ...
      <div class="page-content">
          ...
          <div class="ps-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">My Downline Tree</li>
              </ol>
            </nav>
          </div>
      </div>
        ...
        <div class="row">
          <div class="col-xl-12 mx-auto">
            <h6 class="mb-0 text-uppercase">My Downline Tree</h6>
            <hr/>
            <div class="card border-top border-0 border-4 border-primary">
              <div class="card-body p-9">
                <div class="card-title d-flex align-items-center">
                  ...
                  <h5 class="mb-0 text-primary">My Downline Tree</h5>
                </div>
                <hr>

	                            <center><div class="tree" class="center">
                            ...
                            <li>
                                <ul>
                                    <a href=""style="text-transform: uppercase;"  data-toggle="popover" data-content="Some content inside the popover" class="myDIV">
                                        <img src="{{url('upload/download.png')}}" title="{{$category->name}}"  alt="">
                                    ...
                                    @if(count($category->children))
                                        @include('user.manageChild',['children' => $category->children])
                                    @endif
                                </ul>
                            </li>
                        @endforeach
