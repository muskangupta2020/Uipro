                ...
                <div class="card-body">
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-4">
                            <h6 class="mb-3">To:</h6>
                            <div>
                                <strong>{{$checkout->user_id}}</strong>
                            </div>
                            <div>{{$checkout->address}}</div>
                            <div>{{$checkout->city}}</div>
                            <div>Email: {{$checkout->email}}</div>
                            <div>Phone: +91{{Auth::user()->phone_no}}</div>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="right"><?php echo $dis=$pro->p_total_cost - $pro->p_price; ?></td>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-5">{{$invoice->sale_note}}</div>
                            ...
                            <table class="table table-clear">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="right">
                                            <strong>{{$checkout->total}} Rs</strong>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
